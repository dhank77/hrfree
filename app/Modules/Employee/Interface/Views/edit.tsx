...
interface EmployeeEditProps extends SharedData {
  employee: Employee
...
export default function EmployeeEdit({ employee, departments, positions, managers }: EmployeeEditProps) {
...
EmployeeEdit.layout = (page: React.ReactElement) => <AppLayout children={page} />